...
public class SolicitacaoReciclagemApp {
    private static ArrayList<SolicitacaoReciclagem> solicitacoes = new ArrayList<>();
    ...
    private static void listarSolicitacoesReciclagem() {
        ...
        for (int i = 0; i < solicitacoes.size(); i++) {
            SolicitacaoReciclagem solicitacao = solicitacoes.get(i);
            System.out.println("Solicitação #" + (i + 1));
            System.out.println("Categoria: " + solicitacao.getCategoria());
            System.out.println("Tipo de Lixo: " + solicitacao.getTipoLixo());
            System.out.println("Quantidade em kg: " + solicitacao.getQuantidadeKg());
            System.out.println("Modalidade: " + solicitacao.getModalidadeEntregaRetira());
            System.out.println("Endereço: " + solicitacao.getEndereco());
            System.out.println("Observação: " + solicitacao.getObservacao());
            System.out.println();
        }
    }
    ...
    private static void atualizarSolicitacaoReciclagem() {
        ...
        if (indice >= 1 && indice <= solicitacoes.size()) {
            SolicitacaoReciclagem solicitacao = solicitacoes.get(indice - 1);
